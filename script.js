    ...
    contactForm.addEventListener('submit', function(e) {
      ...
      for (let i = 0; i < formElements.length; i++) {
        ...
        if (field.hasAttribute('required') && !field.value.trim()) {
          ...
          const errorMsg = field.parentElement.querySelector('.error-message') || document.createElement('span');
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "MANO RIVER DIAMONDS uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '1497a578-1ead-4f12-8fac-6a8321ff4b62',
                    name: data.name || '',
                    email: data.email || '',
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1497a578-1ead-4f12-8fac-6a8321ff4b62';
